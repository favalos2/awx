...
options:
    ...
    source:
      ...
      choices: [ "aws_config","scm", "ec2", "gce", "azure_rm", "vmware", "satellite6", "openstack", "rhv", "controller", "insights" ]
      type: str
    source_path:
      description:
...
def main():
    ...
    argument_spec = dict(
        ...
        #
        source=dict(choices=["aws_config","scm", "ec2", "gce", "azure_rm", "vmware", "satellite6", "openstack", "rhv", "controller", "insights"]),
        source_path=dict(),
